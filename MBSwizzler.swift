...
extension NSObject {
    ...
    class func swizzleMethod(origSelector: CString!, withSelector: CString!, forClass:AnyClass!) -> Bool {
    ...
    class func swizzleStaticMethod(origSelector: CString!, withSelector: CString!, forClass:AnyClass!) -> Bool {
